...
"""
tileccl.patterns.producer_consumer - Producer-Consumer overlap pattern.
...
from tileccl.patterns.runtime import resolve_dual_role_scheduler
from tileccl.sync.primitives import tile_signal, tile_wait
...
class ProducerConsumerPattern(Pattern):
    ...
    def _consumer_kernel(
        ...
        :func:`~tileccl.sync.primitives.tile_wait` (acquire semantics) until
