...
"""
tileccl.patterns.auto_select - Automatic pattern selection engine.
...
def _detect_hardware_info():
    ...
    """
    try:
        from tileccl.utils.topology import detect_backend, detect_topology
...
def auto_select(
    ...
    Args:
        ...
        hw_info: Optional hardware info object (e.g.
            :class:`~tileccl.backends.base.DeviceProperties`).  Reserved
    ...
    *,
    ...
    for cls in all_pattern_classes:
        ...
        try:
            ...
            # TODO: Log the exception via tileccl.utils.logging when available.
            results.append({
