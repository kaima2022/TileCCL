...
"""
tileccl.patterns.chained_ag_gemm_rs - Three-stage AllGather → GEMM → Scatter.

A single fused kernel where program instances are partitioned into three
roles using :class:`~tileccl.patterns.runtime.StageRoleScheduler`:
...
Usage::
    ...
    from tileccl.patterns.chained_ag_gemm_rs import ChainedAGGemmRSPattern
...
from tileccl.patterns.runtime import resolve_stage_role_scheduler
from tileccl.sync.primitives import tile_signal, tile_try_wait, tile_wait
