...
"""
tileccl.patterns - Pre-built compute-communication overlap patterns.
...
Typical usage::
    ...
    from tileccl.patterns import auto_select
...
Or benchmark all patterns on a given problem::
    ...
    from tileccl.patterns import benchmark_all_patterns
...
if TYPE_CHECKING:
    ...
    from tileccl.patterns.contracts import PatternExecutionSpec
    ...
    * Implement :meth:`execute` which performs the fused GEMM + communication.
    ...
    def __init__(self, ctx: Any) -> None:
        ...
        Args:
            ctx: Distributed context object carrying at minimum
                ...
                :meth:`~tileccl.memory.symmetric_heap.SymmetricHeap.get_heap_bases`),
                and a ``backend`` implementing
                :class:`~tileccl.backends.base.BackendInterface`.
        """
        self.ctx = ctx
    ...
    def resolve_execution(
        ...
        *,
        ...
        if spec is not None:
            return spec
        from tileccl.patterns.contracts import resolve_pattern_execution
...
from tileccl.patterns.bulk_sync import BulkSyncPattern
from tileccl.patterns.contracts import (
    PatternExecutionSpec,
    PatternTensorSpec,
    resolve_pattern_execution,
)
from tileccl.patterns.fused_sequential import FusedSequentialPattern
from tileccl.patterns.producer_consumer import ProducerConsumerPattern
from tileccl.patterns.wg_specialized import WGSpecializedPattern
