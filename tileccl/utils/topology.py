...
"""tileccl.utils.topology - Hardware topology detection utilities.

Provides functions to detect the GPU backend, query device properties, and
build a topology description that the rest of TileCCL uses to select optimal
...
def print_topology_info(info: TopologyInfo) -> None:
    ...
    """
    print("=" * 60)
    print("  TileCCL Hardware Topology")
    print("=" * 60)
