...
"""
tileccl.memory.translation - Pointer translation engine.
...
code in TileCCL.  ``translate_ptr`` converts a local device pointer into a
...
def translate_ptr(ptr, from_rank, to_rank, heap_bases, HINT: tl.constexpr = 0):
    ...
    This is the most critical function in TileCCL.  It enables zero-copy
