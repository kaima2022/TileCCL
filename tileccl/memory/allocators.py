...
"""Allocator backends for :mod:`tileccl.memory.symmetric_heap`.
...
if TYPE_CHECKING:
    from tileccl.backends.base import BackendInterface
...
class BaseSymmetricAllocator(ABC):
    """Allocator interface used by :class:`tileccl.memory.SymmetricHeap`."""
...
class TorchBumpAllocator(BaseSymmetricAllocator):
    ...
    This is intentionally conservative: it keeps TileCCL's current runtime model
