...
"""Runtime support matrix for public TileCCL surfaces.
...
class RuntimeSupportMatrix:
    """Structured summary of the currently exposed TileCCL support surface."""
    ...
    execution_paths = {
        **reduce_scatter_paths,
        "allgather.legacy": _describe_non_allreduce_legacy_path_support(
            ...
            operation="tileccl.primitives.allgather(...)",
            has_heap=has_heap,
            heap_mode=heap_mode,
            transport_strategy=transport_strategy,
            world_size=world_size,
        ...
        "broadcast.legacy": _describe_non_allreduce_legacy_path_support(
            ...
            operation="tileccl.primitives.broadcast(...)",
            has_heap=has_heap,
            heap_mode=heap_mode,
            transport_strategy=transport_strategy,
            world_size=world_size,
        ...
        "scatter.legacy": _describe_non_allreduce_legacy_path_support(
            collective="scatter",
            operation="tileccl.primitives.scatter(...)",
            has_heap=has_heap,
            heap_mode=heap_mode,
            transport_strategy=transport_strategy,
            world_size=world_size,
