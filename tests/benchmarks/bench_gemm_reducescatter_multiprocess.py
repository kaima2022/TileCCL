...
"""Structured multiprocess gemm_reducescatter matrix."""
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-json",
        type=str,
        default=str(Path("docs/generated/gemm_reducescatter_multiprocess_matrix.json")),
...
def _aggregate_rank_payloads(payloads: list[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        ...
        "plan_queue_slots": payloads[0]["plan_queue_slots"],
        "plan_credit_window": payloads[0]["plan_credit_window"],
        "plan_tile_rows": payloads[0]["plan_tile_rows"],
...
def main() -> None:
    """Run the structured multiprocess GEMM + reduce-scatter matrix."""
    ...
    payload = {
        "schema_version": 1,
        "benchmark": "gemm_reducescatter_multiprocess_matrix",
