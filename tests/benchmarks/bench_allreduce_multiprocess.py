#!/usr/bin/env python3
"""Structured multiprocess allreduce matrix."""
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-json",
        type=str,
        default=str(Path("docs/generated/allreduce_multiprocess_matrix.json")),
...
def main() -> None:
    """Run the structured multiprocess allreduce matrix."""
    ...
    payload = {
        "schema_version": 1,
        "benchmark": "allreduce_multiprocess_matrix",
