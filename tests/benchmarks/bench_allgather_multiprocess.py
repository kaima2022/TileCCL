#!/usr/bin/env python3
"""Structured multiprocess allgather matrix."""
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--block-size", type=int, default=128, help="Allgather chunk size.")
    parser.add_argument(
        "--timeout-sec",
        type=int,
        default=180,
    ...
    parser.add_argument(
        "--output-json",
        type=str,
        default=str(Path("docs/generated/allgather_multiprocess_matrix.json")),
...
def main() -> None:
    """Run the structured multiprocess allgather matrix."""
    ...
    payload = {
        "schema_version": 1,
        "benchmark": "allgather_multiprocess_matrix",
