...
"""
tncc.backends.cuda - NVIDIA CUDA backend for TNCC.

Implements :class:`~tncc.backends.base.BackendInterface` by wrapping the
...
class CUDABackend(BackendInterface):
    """NVIDIA CUDA implementation of :class:`~tncc.backends.base.BackendInterface`.
