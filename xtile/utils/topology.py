"""xtile.utils.topology - Hardware topology detection utilities.

Provides functions to detect the GPU backend, query device properties, and
build a topology description that the rest of XTile uses to select optimal
